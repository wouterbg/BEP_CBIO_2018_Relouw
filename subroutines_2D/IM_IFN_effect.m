function pblock = IM_IFN_effect(IM1cells,TUcells,L_size,TUpblock_start,TUpblock_change,disk)
...
IM1cells_on = IM1cells(boolean((dist_map(IM1cells)<2)));
...
pblock = min(TUpblock_start+tot(TUcells).*TUpblock_change,1);
end